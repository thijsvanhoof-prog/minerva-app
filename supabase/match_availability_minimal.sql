-- Match availability (Speler / Trainer/coach / Speel niet / Afmelden) voor Sport → Wedstrijden
--
-- Gebruikt door: Sport-tab → Wedstrijden. Zonder deze tabel krijg je
-- "Could not find the table 'public.match_availability'" bij opslaan.
--
